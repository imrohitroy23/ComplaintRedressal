...
@Component({
  selector: 'app-individual-complaint-details',
  templateUrl: './individual-complaint-details.component.html',
  styleUrls: ['./individual-complaint-details.component.css']
})
export class IndividualComplaintDetailsComponent {
